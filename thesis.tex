...
\input{contents/2_key_terms_and_definitions.tex}
\input{contents/3_literature_review.tex}
\input{contents/4_requirements.tex}
\input{contents/5_architecture.tex}
\input{contents/6_design_and_implementation.tex}
\input{contents/7_evaluation.tex}
\input{contents/8_conclusions.tex}
