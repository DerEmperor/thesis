...
Germany passed its own privacy laws in 1977 called the . It had to be revised upon the adoption of the \ac{GDPR}. Today the \ac{BDSG} and \ac{DSGVO} complement each other, since the \ac{GDPR} has escape clauses, where the \ac{BDSG} steps in. This applies, for example, to the processing of employee data or the establishment of supervisory authorities.
