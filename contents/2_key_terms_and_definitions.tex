...
Some parts of the \ac{GDPR} can be changed or complemented by the states. Germany added the \ac{BDSG} (englisch Federal Data Protection Act) to the \ac{DSGVO} to expand the mandatory regulations.
