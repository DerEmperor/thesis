...
According to the \ac{BDSG}, personal data may only be collected, processed, or used for a specific purpose. It is forbidden to use this data for other purposes. There are only a few specific exceptions for this rule. \autocite[72]{daeubler2017glaeserne}
