...
They are sorted by \ac{NFLR}, \ac{NFSR}, and \ac{NFIR}.
 ...
 \begin{table}[ht]
 	...
 	\begin{tabular}{|p{1.5cm}|p{4cm}|p{8cm}|}
 		...
 		The contributing guidelines state that dependencies should be kept to a minimum and forbids packages with a copyleft or proprietary license.  \autocite{github_mecois} \\
 		\hline
