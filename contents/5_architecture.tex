...
Services are helper modules that support pipelines and analytics operations. Key service modules include:

\begin{itemize}
	\item \textbf{AI:} A framework for interacting with \acp{LLM}.
	\item \textbf{Config Handling:} Parses and validates configuration files for pipeline executions.
\end{itemize}
...
\begin{figure}[ht] \centering \includegraphics[width=\textwidth]{resources/SortingHatUML.jpg} \caption{SortingHat UML diagram \autocite{duenas2021grimoirelab}} \label{fig:sortinghat_uml_diagram} \end{figure}
